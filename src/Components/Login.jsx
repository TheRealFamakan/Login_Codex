  ...
  return (
    <div className='w-full max-w-[400px] bg-white p-6 rounded-3xl shadow-2xl'>
      ...
      <div className='flex flex-col items-center mb-6'>
        <div className="w-14 h-14 bg-gradient-to-br from-blue-500 to-cyan-400 rounded-full mb-3 shadow-lg"></div>
      ...
      <form className='space-y-3'>
        ...
        {/* Shared button */}
        <button type="submit" className='w-full p-3 mt-2 bg-gradient-to-r from-cyan-400 to-blue-500 text-white rounded-xl text-sm font-bold hover:shadow-lg hover:from-cyan-500 hover:to-blue-600 transition-all flex justify-center items-center gap-2'>
          {isLoginMode ? "Login ->" : "Register ->"}
        </button>

        <div className="relative flex py-2 items-center">
          <div className="flex-grow border-t border-gray-200"></div>
          <span className="flex-shrink-0 mx-4 text-gray-300 text-xs">Or continue with</span>
          <div className="flex-grow border-t border-gray-200"></div>
        </div>
